...
#Solución con MoM de onda plana en 2D en un cilindro centrado en el origen y propagación en medio con perdidas
...
sigma_c = 0.4
epsono_r_c = 60.+ sigma_c/(2j*pi*freq*eps0) # the constant relative permittivity of the object
...
np.random.seed(0)
Jo = 0.1*(1+1j)*np.random.randn(M**2,Ni) # M^2 x Ni
