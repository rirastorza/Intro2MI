...
M = 100
niter = 200 
npzfile2 = np.load('test_M_'+str(M)+'_niter_'+str(niter)+'.npz')

M = 150
niter = 200 
npzfile3 = np.load('test_M_'+str(M)+'_niter_'+str(niter)+'.npz')

M = 200
niter = 200 
npzfile4 = np.load('test_M_'+str(M)+'_niter_'+str(niter)+'.npz')
...
axs[0].plot(abs(npzfile2['Es'][:,nantena_inc]),'-',color = 'tab:blue',label='M:100, niter:200')
axs[0].plot(abs(npzfile3['Es'][:,nantena_inc]),'--',color = 'darkblue',label='M:150, niter:200')
axs[0].plot(abs(npzfile4['Es'][:,nantena_inc]),'o-',color = 'darkblue',label='M:200, niter:200')
