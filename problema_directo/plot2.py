...
ax2.semilogx(1e6*datos[:,0],datos[:,3],'g-',label='Incidente S14')
ax2.semilogx(1e6*datos_canonico[:,0],datos_canonico[:,3],'g--',label='S14 Teflon')
ax2.semilogx(1e6*datos[:,0],datos[:,4],'m-',label='Incidente S15')
ax2.semilogx(1e6*datos_canonico[:,0],datos_canonico[:,4],'m--',label='S15 Teflon')

ax2.set_ylim([-75, -25])
ax2.legend(loc="lower right")

ax3 = fig8.add_subplot(212)
ax3.semilogx(1e6*datos[:,0],datos[:,5],'b-',label='Incidente S16')
ax3.semilogx(1e6*datos_canonico[:,0],datos_canonico[:,5],'b--',label='S16 Teflon')
ax3.semilogx(1e6*datos[:,0],datos[:,6],'r-',label='Incidente S17')
ax3.semilogx(1e6*datos_canonico[:,0],datos_canonico[:,6],'r--',label='S17 Teflon')
ax3.semilogx(1e6*datos[:,0],datos[:,7],'g-',label='Incidente S18')
ax3.semilogx(1e6*datos_canonico[:,0],datos_canonico[:,7],'g--',label='S18 Teflon')
...
ax2.semilogx(1e6*datos[:,0],datos[:,1],'b-',label='Incidente S12')
ax2.semilogx(1e6*datos_cilindronylon[:,0],datos_cilindronylon[:,1],'b--',label='S12 Nylon')
ax2.semilogx(1e6*datos[:,0],datos[:,2],'r-',label='Incidente S13')
ax2.semilogx(1e6*datos_cilindronylon[:,0],datos_cilindronylon[:,2],'r--',label='S13 Nylon')
ax2.semilogx(1e6*datos[:,0],datos[:,3],'g-',label='Incidente S14')
ax2.semilogx(1e6*datos_cilindronylon[:,0],datos_cilindronylon[:,3],'g--',label='S14 Nylon')
ax2.semilogx(1e6*datos[:,0],datos[:,4],'m-',label='Incidente S15')
ax2.semilogx(1e6*datos_cilindronylon[:,0],datos_cilindronylon[:,4],'m--',label='S15 Nylon')
...
ax3.semilogx(1e6*datos[:,0],datos[:,5],'b-',label='Incidente S16')
ax3.semilogx(1e6*datos_cilindronylon[:,0],datos_cilindronylon[:,5],'b--',label='S16 Nylon')
ax3.semilogx(1e6*datos[:,0],datos[:,6],'r-',label='Incidente S17')
ax3.semilogx(1e6*datos_cilindronylon[:,0],datos_cilindronylon[:,6],'r--',label='S17 Nylon')
ax3.semilogx(1e6*datos[:,0],datos[:,7],'g-',label='Incidente S18')
ax3.semilogx(1e6*datos_cilindronylon[:,0],datos_cilindronylon[:,7],'g--',label='S18 Nylon')
