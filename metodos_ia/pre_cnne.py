...
#picture = np.reshape(picture,(8,8))
...
#numtrain = 6000 #nro de datos de entrenamiento
...
##with open("cnn_AmplitudeOnly2.json", "w") as json_file:
    ##json_file.write(model_json)
### serialize weights to HDF5
##model.save_weights("cnn_AmplitudeOnly2.h5")
...
#pyplot.ylim((-9.0e-2,9.0e-2))
#pyplot.xlim((-9.0e-2,9.0e-2))
#pyplot.xlabel('Valor Predicho')
#pyplot.ylabel('Valor Real')
#pyplot.legend(loc='lower right', shadow='False')
...
#pyplot.ylim((2.0,85.0))
#pyplot.xlim((2.0,85.0))
#pyplot.xlabel('Valor Predicho')
#pyplot.ylabel('Valor Real')
#pyplot.legend(loc='lower right', shadow='False')
...
#pyplot.ylim((0.1e-4,1.8))
#pyplot.xlim((0.1e-4,1.8))
#pyplot.xlabel('Valor Predicho')
#pyplot.ylabel('Valor Real')
#pyplot.legend(loc='lower right', shadow='False')
